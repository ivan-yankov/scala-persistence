...
import org.yankov.serialization.xml.XmlDataModel.{Bytes, FieldNotFoundError, FieldValue, JsonDeserializationError, XmlNode, JsonParseError}
...
//    try {
//      val jsonFlatten = Tree(XmlNode("", json)).flat()
